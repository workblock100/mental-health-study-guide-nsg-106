// MENTAL HEALTH REVIEW RUNNER - Study Game 2025
// Mental Health Units 1 & 2 nursing review game with questions

const gameQuizQuestions = [
    // LEGAL & ETHICAL FRAMEWORK
    { q: "A client who is voluntarily admitted to a psychiatric unit has which of the following rights? (Select all that apply)", category: "legal", type: "sata", options: ["Right to refuse medications", "Right to request release", "Right to leave against medical advice", "Must stay until provider says so", "Considered competent"], correctAnswers: ["Right to refuse medications", "Right to request release", "Considered competent"], explanation: "Voluntary admission clients are competent, can refuse treatment, and may request release." },
    { q: "An involuntarily admitted client demands to leave. Which response by the nurse is appropriate?", category: "legal", options: ["You cannot leave because you are under a court order", "You have the right to leave, but we advise against it", "You can request a legal review of your admission at any time", "If you try to leave, we will put you in restraints"], correctAnswer: "You can request a legal review of your admission at any time", explanation: "Even involuntary clients retain the right to legal review." },
    { q: "Which are criteria for involuntary psychiatric admission? (Select all that apply)", category: "legal", type: "sata", options: ["Danger to self", "Danger to others", "Gravely disabled", "Refusing to take medications", "Anxiety symptoms"], correctAnswers: ["Danger to self", "Danger to others", "Gravely disabled"], explanation: "Involuntary admission requires danger to self/others or inability to care for self." },
    { q: "Confining a client for convenience or punishment without justification is called:", category: "legal", options: ["Assault", "Battery", "False imprisonment", "Negligence"], correctAnswer: "False imprisonment", explanation: "False imprisonment is unlawful confinement." },
    { q: "A nurse says 'If you don't take this pill, I'll inject you.' This is an example of:", category: "legal", options: ["Battery", "Assault", "False imprisonment", "Defamation"], correctAnswer: "Assault", explanation: "Assault is making a threat." },
    { q: "Touching a client without consent (such as giving an injection after a threat) is:", category: "legal", options: ["Assault", "Battery", "Negligence", "Malpractice"], correctAnswer: "Battery", explanation: "Battery is touching without consent." },
    { q: "The Tarasoff Rule (Duty to Warn) requires the nurse to:", category: "legal", options: ["Maintain confidentiality at all times", "Warn a third party if a client makes a specific threat against a specific person", "Report all violent thoughts", "Contact the police immediately"], correctAnswer: "Warn a third party if a client makes a specific threat against a specific person", explanation: "Tarasoff is an exception to confidentiality for specific threats." },
    { q: "How many physicians are typically required for involuntary admission?", category: "legal", options: ["1", "2", "3", "4"], correctAnswer: "2", explanation: "Involuntary commitment typically requires 2 physicians." },
    { q: "Within how many hours must an involuntary admission be reviewed?", category: "legal", options: ["24 hours", "48 hours", "72 hours", "1 week"], correctAnswer: "72 hours", explanation: "Review must occur within 72 hours." },

    // THERAPEUTIC COMMUNICATION
    { q: "Which therapeutic communication techniques should the nurse use? (Select all that apply)", category: "communication", type: "sata", options: ["Silence", "Restating and reflecting", "Open-ended questions", "Offering self", "Asking 'Why'"], correctAnswers: ["Silence", "Restating and reflecting", "Open-ended questions", "Offering self"], explanation: "Silence, restating, open-ended questions, and offering self are therapeutic. 'Why' is not." },
    { q: "Which statements should the nurse AVOID? (Select all that apply)", category: "communication", type: "sata", options: ["Why did you do that?", "Everything will be okay", "You should talk to your mother", "Everyone feels that way sometimes", "Tell me more about that"], correctAnswers: ["Why did you do that?", "Everything will be okay", "You should talk to your mother", "Everyone feels that way sometimes"], explanation: "Avoid 'why' questions, false reassurance, advice giving, and minimizing feelings." },
    { q: "A client says 'I feel so angry.' Which response demonstrates reflecting?", category: "communication", options: ["Why are you angry?", "You feel angry when this happens", "Don't worry, it will pass", "You should try deep breathing"], correctAnswer: "You feel angry when this happens", explanation: "Reflecting validates and mirrors feelings back to the client." },
    { q: "Which response demonstrates offering self?", category: "communication", options: ["Everything will be fine", "You should talk to someone", "I will sit with you", "Why are you upset?"], correctAnswer: "I will sit with you", explanation: "Offering self shows presence and interest." },
    { q: "'Tell me more about that' is an example of:", category: "communication", options: ["Closed-ended question", "Open-ended question", "False reassurance", "Advice giving"], correctAnswer: "Open-ended question", explanation: "Open-ended questions encourage sharing." },

    // DEFENSE MECHANISMS
    { q: "Which defense mechanisms are ALWAYS considered healthy? (Select all that apply)", category: "defense", type: "sata", options: ["Altruism", "Sublimation", "Denial", "Projection", "Displacement"], correctAnswers: ["Altruism", "Sublimation"], explanation: "Altruism and sublimation are the only two always healthy defenses." },
    { q: "An angry person goes to the gym to work out instead of acting aggressively. This is:", category: "defense", options: ["Displacement", "Sublimation", "Projection", "Denial"], correctAnswer: "Sublimation", explanation: "Sublimation substitutes an acceptable activity for an unacceptable impulse." },
    { q: "After being yelled at by the boss, a person goes home and kicks the dog. This is:", category: "defense", options: ["Sublimation", "Displacement", "Projection", "Reaction formation"], correctAnswer: "Displacement", explanation: "Displacement shifts feelings to a less threatening object." },
    { q: "A person who dislikes their neighbor bakes them cookies. This is:", category: "defense", options: ["Displacement", "Projection", "Reaction formation", "Sublimation"], correctAnswer: "Reaction formation", explanation: "Reaction formation is overcompensating by doing the opposite of what is felt." },
    { q: "A cheating spouse accuses their partner of cheating. This is:", category: "defense", options: ["Reaction formation", "Displacement", "Projection", "Denial"], correctAnswer: "Projection", explanation: "Projection attributes own thoughts to others." },
    { q: "Inability to reconcile positive and negative aspects - seeing everyone as 'all good' or 'all bad' - is characteristic of:", category: "defense", options: ["Projection", "Splitting", "Displacement", "Denial"], correctAnswer: "Splitting", explanation: "Splitting is a red flag for Borderline Personality Disorder." },
    { q: "A client didn't get a job and says 'It's probably for the best because it was too far anyway.' This is:", category: "defense", options: ["Denial", "Rationalization", "Projection", "Sublimation"], correctAnswer: "Rationalization", explanation: "Rationalization creates reasonable explanations for unacceptable outcomes." },

    // LEVELS OF ANXIETY
    { q: "Which level of anxiety increases focus and learning?", category: "anxiety", options: ["Mild", "Moderate", "Severe", "Panic"], correctAnswer: "Mild", explanation: "Mild anxiety is everyday stress that increases focus." },
    { q: "A client has selective inattention, headache, and learning is hampered but possible. This is:", category: "anxiety", options: ["Mild", "Moderate", "Severe", "Panic"], correctAnswer: "Moderate", explanation: "Moderate anxiety features selective inattention and somatic symptoms." },
    { q: "The appropriate intervention for moderate anxiety is:", category: "anxiety", options: ["Simple directives only", "Ask open-ended questions and encourage talk", "Stay with client, minimal stimulation", "Immediate sedation"], correctAnswer: "Ask open-ended questions and encourage talk", explanation: "Moderate anxiety responds to open-ended questions and talk." },
    { q: "A client has distorted perception, hyperventilation, and learning is impossible. This is:", category: "anxiety", options: ["Mild", "Moderate", "Severe", "Panic"], correctAnswer: "Severe", explanation: "Severe anxiety features distorted perception and inability to learn." },
    { q: "The appropriate intervention for severe anxiety is:", category: "anxiety", options: ["Teach relaxation techniques", "Ask open-ended questions", "Simple directives", "Let the client be alone"], correctAnswer: "Simple directives", explanation: "Severe anxiety requires simple, clear directives." },
    { q: "A client is pacing, hyperventilating, and says 'I feel like I'm going to die.' They cannot follow instructions. The priority intervention is:", category: "anxiety", options: ["Teach deep breathing exercises", "Ask what triggered this feeling", "Move to a quiet, low-stimulation environment", "Administer PRN benzodiazepine immediately"], correctAnswer: "Move to a quiet, low-stimulation environment", explanation: "Panic level requires safety and minimal stimulation first." },
    { q: "At the panic level of anxiety, the client may experience: (Select all that apply)", category: "anxiety", type: "sata", options: ["Lost touch with reality", "Hallucinations", "Immobility or flight", "Enhanced learning", "Increased focus"], correctAnswers: ["Lost touch with reality", "Hallucinations", "Immobility or flight"], explanation: "Panic features reality loss, hallucinations, and immobility/flight." },

    // SECLUSION & RESTRAINTS
    { q: "The correct order of interventions before restraints is:", category: "restraints", options: ["Restraints, then PRN meds", "Verbal, diversion, PRN meds, seclusion, then restraints", "Seclusion first, then verbal", "PRN meds, then verbal"], correctAnswer: "Verbal, diversion, PRN meds, seclusion, then restraints", explanation: "Use least restrictive means first." },
    { q: "The time limit for restraints on an adult is:", category: "restraints", options: ["1 hour", "2 hours", "4 hours", "8 hours"], correctAnswer: "4 hours", explanation: "Adults: 4 hours, 9-17: 2 hours, <9: 1 hour." },
    { q: "The time limit for restraints on a client aged 9-17 is:", category: "restraints", options: ["1 hour", "2 hours", "4 hours", "8 hours"], correctAnswer: "2 hours", explanation: "Ages 9-17: 2 hour limit." },
    { q: "How often must a client in restraints be documented?", category: "restraints", options: ["Every hour", "Every 15-30 minutes", "Every 4 hours", "Once per shift"], correctAnswer: "Every 15-30 minutes", explanation: "Check circulation, food/fluids, toileting every 15-30 mins." },
    { q: "A provider must see a client in emergency restraints within:", category: "restraints", options: ["30 minutes", "1 hour", "2 hours", "4 hours"], correctAnswer: "1 hour", explanation: "Provider must see client within 1 hour." },
    { q: "During a group session, a client threatens another with a chair. After calling for help, what is the next action?", category: "restraints", options: ["Place client in mechanical restraints", "Administer IM antipsychotic", "Tell client calmly to put the chair down", "Evacuate the other clients from the room"], correctAnswer: "Evacuate the other clients from the room", explanation: "Safety first - remove potential victims." },

    // TRANSFERENCE & COUNTERTRANSFERENCE
    { q: "A client says 'You act just like my mother.' This is an example of:", category: "therapy", options: ["Countertransference", "Transference", "Projection", "Splitting"], correctAnswer: "Transference", explanation: "Transference is when client views nurse as a person from their past." },
    { q: "A nurse dislikes a client because they remind her of an ex. This is:", category: "therapy", options: ["Transference", "Countertransference", "Projection", "Displacement"], correctAnswer: "Countertransference", explanation: "Countertransference is nurse projecting past feelings onto client." },

    // FAMILY THERAPY DYNAMICS
    { q: "In a family where thoughts and roles blend with no independence, the boundaries are:", category: "family", options: ["Rigid", "Enmeshed", "Healthy", "Triangulated"], correctAnswer: "Enmeshed", explanation: "Enmeshed boundaries have no independence." },
    { q: "In a family where there is isolation and no sharing of feelings, the boundaries are:", category: "family", options: ["Enmeshed", "Rigid", "Healthy", "Flexible"], correctAnswer: "Rigid", explanation: "Rigid boundaries create isolation." },
    { q: "Two people pulling in a third party to stabilize conflict is called:", category: "family", options: ["Scapegoating", "Triangulation", "Enmeshment", "Splitting"], correctAnswer: "Triangulation", explanation: "Triangulation involves third party in conflict." },
    { q: "Blaming the family member with least power for family problems is:", category: "family", options: ["Triangulation", "Scapegoating", "Enmeshment", "Projection"], correctAnswer: "Scapegoating", explanation: "Scapegoating usually targets a child." },

    // PSYCHOANALYTIC THEORY (FREUD)
    { q: "The part of personality that operates on the pleasure principle and says 'I want it now' is the:", category: "freud", options: ["Ego", "Superego", "Id", "Conscience"], correctAnswer: "Id", explanation: "Id is pleasure principle and instincts." },
    { q: "The part of personality that balances Id and Superego using reality is the:", category: "freud", options: ["Id", "Ego", "Superego", "Conscience"], correctAnswer: "Ego", explanation: "Ego is the reality principle." },
    { q: "The part of personality that is the moral compass and says 'It's wrong to do that' is the:", category: "freud", options: ["Id", "Ego", "Superego", "Self"], correctAnswer: "Superego", explanation: "Superego is the conscience." },

    // MEDICATIONS
    { q: "Diazepam (Valium) works by:", category: "meds", options: ["Blocking dopamine", "Enhancing GABA", "Blocking serotonin reuptake", "Stimulating norepinephrine"], correctAnswer: "Enhancing GABA", explanation: "Benzodiazepines enhance GABA to calm CNS." },
    { q: "Red flags with benzodiazepines include: (Select all that apply)", category: "meds", type: "sata", options: ["Respiratory depression", "Sedation and drowsiness", "Tolerance and dependence", "Increased energy", "Weight gain"], correctAnswers: ["Respiratory depression", "Sedation and drowsiness", "Tolerance and dependence"], explanation: "Monitor RR, fall risk, and limit to short-term use." },
    { q: "The antidote for benzodiazepine overdose is:", category: "meds", options: ["Naloxone", "Flumazenil", "Atropine", "Epinephrine"], correctAnswer: "Flumazenil", explanation: "Flumazenil reverses benzodiazepines." },
    { q: "Side effects of typical antipsychotics like Haloperidol include: (Select all that apply)", category: "meds", type: "sata", options: ["EPS (Extrapyramidal Symptoms)", "NMS (Neuroleptic Malignant Syndrome)", "Tardive Dyskinesia", "Weight loss", "Euphoria"], correctAnswers: ["EPS (Extrapyramidal Symptoms)", "NMS (Neuroleptic Malignant Syndrome)", "Tardive Dyskinesia"], explanation: "Watch for EPS, NMS (medical emergency), and TD (irreversible)." },
    { q: "Neuroleptic Malignant Syndrome presents with: (Select all that apply)", category: "meds", type: "sata", options: ["High fever", "Muscle rigidity", "Altered mental status", "Low blood pressure", "Weight gain"], correctAnswers: ["High fever", "Muscle rigidity", "Altered mental status"], explanation: "NMS is a medical emergency - high fever and rigidity." },

    // LAB VALUES
    { q: "Hyperthyroidism can mimic which psychiatric condition?", category: "labs", options: ["Depression", "Mania or anxiety", "Schizophrenia", "OCD"], correctAnswer: "Mania or anxiety", explanation: "Always rule out medical causes first." },
    { q: "Hypothyroidism can mimic which psychiatric condition?", category: "labs", options: ["Mania", "Anxiety", "Depression", "Psychosis"], correctAnswer: "Depression", explanation: "Hypothyroid mimics depression symptoms." },
    { q: "The #1 cause of acute confusion/delirium in older adults is:", category: "labs", options: ["Depression", "UTI", "Stroke", "Medication side effect"], correctAnswer: "UTI", explanation: "UTI is the most common cause of delirium in elderly." },
    { q: "Hyponatremia can cause: (Select all that apply)", category: "labs", type: "sata", options: ["Confusion", "Seizures", "Mental status changes", "Euphoria", "Weight loss"], correctAnswers: ["Confusion", "Seizures", "Mental status changes"], explanation: "Low sodium affects brain function." },

    // FLASHCARD TERMS
    { q: "The duty to do good (such as spending extra time with an anxious client) is called:", category: "ethics", options: ["Autonomy", "Beneficence", "Fidelity", "Justice"], correctAnswer: "Beneficence", explanation: "Beneficence is the duty to do good." },
    { q: "The client's right to make their own decisions is called:", category: "ethics", options: ["Beneficence", "Autonomy", "Fidelity", "Veracity"], correctAnswer: "Autonomy", explanation: "Autonomy includes right to refuse meds." },
    { q: "Loyalty and faithfulness to duties and promises is called:", category: "ethics", options: ["Veracity", "Justice", "Fidelity", "Beneficence"], correctAnswer: "Fidelity", explanation: "Fidelity is keeping promises." },
    { q: "Honesty and telling the truth is called:", category: "ethics", options: ["Fidelity", "Veracity", "Justice", "Autonomy"], correctAnswer: "Veracity", explanation: "Veracity is truthfulness." },
    { q: "Fair and equal treatment for all clients is called:", category: "ethics", options: ["Beneficence", "Autonomy", "Fidelity", "Justice"], correctAnswer: "Justice", explanation: "Justice is fair treatment." },
    { q: "Structuring the environment to be therapeutic and safe is called:", category: "therapy", options: ["CBT", "Milieu therapy", "Group therapy", "Psychoanalysis"], correctAnswer: "Milieu therapy", explanation: "Milieu therapy structures the environment." },
    { q: "A civil wrong resulting in injury or harm is called:", category: "legal", options: ["Crime", "Tort", "Misdemeanor", "Felony"], correctAnswer: "Tort", explanation: "Torts can be intentional or unintentional." },
    { q: "Failure to provide standard of care (unintentional tort) is:", category: "legal", options: ["Battery", "Assault", "Negligence", "False imprisonment"], correctAnswer: "Negligence", explanation: "Negligence is unintentional failure of care." },
    { q: "The objective, visible expression of mood is called:", category: "terms", options: ["Mood", "Affect", "Behavior", "Cognition"], correctAnswer: "Affect", explanation: "Affect is observable (flat, blunted, etc)." },
    { q: "The subjective internal emotion is called:", category: "terms", options: ["Affect", "Mood", "Behavior", "Perception"], correctAnswer: "Mood", explanation: "Mood is what the client says they feel." },
    { q: "Speech that wanders from the topic and never returns is:", category: "terms", options: ["Flight of ideas", "Tangentiality", "Word salad", "Neologism"], correctAnswer: "Tangentiality", explanation: "Tangentiality never returns to the point." },
    { q: "Rapid shifting of topics with a connection between them is:", category: "terms", options: ["Tangentiality", "Flight of ideas", "Word salad", "Loose associations"], correctAnswer: "Flight of ideas", explanation: "Flight of ideas has rapid connected shifts." },
    { q: "A jumble of meaningless words (seen in Schizophrenia) is:", category: "terms", options: ["Neologism", "Tangentiality", "Word salad", "Echolalia"], correctAnswer: "Word salad", explanation: "Word salad is meaningless speech." },
    { q: "Made-up words are called:", category: "terms", options: ["Word salad", "Neologism", "Echolalia", "Tangentiality"], correctAnswer: "Neologism", explanation: "Neologisms are invented words." },
    { q: "Behavioral therapy involving gradual exposure for phobias is:", category: "therapy", options: ["Flooding", "Systematic desensitization", "CBT", "ECT"], correctAnswer: "Systematic desensitization", explanation: "Gradual exposure reduces fear." },
    { q: "Immediate, full exposure to a phobia stimulus is:", category: "therapy", options: ["Systematic desensitization", "Flooding", "Aversion therapy", "Modeling"], correctAnswer: "Flooding", explanation: "Flooding is immediate full exposure." },
    { q: "Treatment-resistant depression may be treated with:", category: "therapy", options: ["Only medication", "ECT (Electroconvulsive Therapy)", "Just therapy", "Exercise only"], correctAnswer: "ECT (Electroconvulsive Therapy)", explanation: "ECT induces seizure for severe depression." },
    { q: "The ability to adapt and cope with stress is called:", category: "terms", options: ["Resilience", "Coping", "Defense", "Adaptation"], correctAnswer: "Resilience", explanation: "Resilience is adaptive capacity." },
    { q: "Unconscious methods to lower anxiety are called:", category: "terms", options: ["Coping mechanisms", "Ego defense mechanisms", "Stress responses", "Adaptive behaviors"], correctAnswer: "Ego defense mechanisms", explanation: "Defense mechanisms are unconscious." },
    { q: "According to Maslow, which need must be met first?", category: "theory", options: ["Safety", "Love and belonging", "Physiological", "Esteem"], correctAnswer: "Physiological", explanation: "Physiological needs are the base of the hierarchy." },
    { q: "A client asks the nurse to keep secret a plan to harm their partner. The nurse should respond:", category: "legal", options: ["I promise I won't tell anyone", "I cannot keep secrets that involve harm to others", "Why do you want to harm your partner?", "Let's talk about why you feel this way"], correctAnswer: "I cannot keep secrets that involve harm to others", explanation: "Duty to Warn - confidentiality has exceptions for safety." },
    { q: "Involuntary admission automatically means the client is incompetent.", category: "legal", options: ["True", "False"], correctAnswer: "False", explanation: "Involuntary clients can still refuse meds - separate court hearing needed for incompetence." }
];

class MentalHealthRunner {
    constructor(canvas) {
        this.canvas = canvas;
        ...
        this.comboTimer = 0;
        this.level = 1;
        this.highScore = parseInt(localStorage.getItem('mentalHealthHS')) || 0;
        this.totalCoins = parseInt(localStorage.getItem('mentalHealthCoins')) || 0;
        ...
        // Achievements
        this.achievements = JSON.parse(localStorage.getItem('mentalHealthAchievements')) || {};
        ...
        // Lifetime stats
        this.stats = JSON.parse(localStorage.getItem('mentalHealthStats')) || {
            totalRuns: 0,
            totalDistance: 0,
            totalCoins: 0,
            totalQuestions: 0,
        ...
        this.currentOutfit = localStorage.getItem('mentalHealthOutfit') || 'teal';
        const savedOutfits = JSON.parse(localStorage.getItem('mentalHealthOwnedOutfits') || '{}');
        Object.keys(savedOutfits).forEach(k => { if (this.outfits[k]) this.outfits[k].owned = savedOutfits[k]; });

        // SOUND EFFECTS (Web Audio API)
        this.audioCtx = null;
        this.soundEnabled = localStorage.getItem('mentalHealthSoundEnabled') !== 'false';
    ...
    gameOver() {
        this.state = 'gameover';
        if (this.score > this.highScore) { this.highScore = this.score; localStorage.setItem('mentalHealthHS', this.highScore); }
...
let mhRunner = null;
function initGame() { const c = document.getElementById('gameCanvas'); if (!c) return; if (mhRunner) mhRunner.stop(); mhRunner = new MentalHealthRunner(c); mhRunner.start(); }
function stopGame() { if (mhRunner) { mhRunner.stop(); mhRunner = null; } }
window.addEventListener('resize', () => { if (mhRunner) mhRunner.resize(); });
